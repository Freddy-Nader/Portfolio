      ...
      <main>
        ...
        <CV.CVSection title="Languages">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <CV.Language lang="Spanish" level="Native Language" />
            <CV.Language lang="English" level="Second Language" />
            <CV.Language lang="Italian" level="Professional Working Proficiency" />
          </div>
        </CV.CVSection>
